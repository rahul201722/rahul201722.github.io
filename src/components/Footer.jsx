...
export default function Footer({ profile }) {
  ...
  return (
    <footer className="bg-primary text-white py-10 px-3 sm:px-5 lg:px-6">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          {/* About */}
          <div>
            <h3 className="text-base font-semibold mb-2">{profile.name}</h3>
        ...
        <div className="border-t border-white/20 pt-5 text-center text-sm text-white/60">
