# Rahul Ranjan - ML Engineer & AI Researcher

Personal portfolio website showcasing ML engineering expertise, AI research, and published work.
...
- Lightweight and fast (~37KB)
- Custom animations and effects

## Features
- ✨ Dynamic particle animations
- 📑 Tabbed navigation (Experience, Projects, Education, Skills, Publications)
- 📱 Fully mobile responsive
- 🎨 Modern gradient design with green color scheme
- 🔄 Smooth transitions and hover effects
- 📊 Stats showcase with key achievements
